...
$pageTitle = "Danh sách quản trị viên"; ob_start();
?>
<div class="card shadow-sm border-0">
    <div class="card-header bg-white border-0 pt-4 pb-0 d-flex justify-content-between">
        <h5 class="fw-bold text-secondary">Danh sách người dùng</h5>
    ...
    <div class="card-body">
        ...
        <?php if(empty($users)) { echo "<div class='alert alert-warning'>Không tìm thấy.</div>"; } else { ?>
            <table class="table table-hover">
                <thead><tr><th>ID</th><th>Họ tên</th><th>Tên đăng nhập</th><th>Vai trò</th><th>Chức năng</th></tr></thead>
                <tbody>
